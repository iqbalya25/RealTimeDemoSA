        ...
        <div className="w-full md:w-[80%] max-w-[1000px] text-justify text-white p-4 md:p-0   mt-20">
          ...
          <div className="text-xl">
            <p className="text-sm md:text-xl">
              ...
              system to reduce total energy costs and carbon footprint
              significantly. Our solutions enable building occupants to remain
              comfortable and productive while the building system performance
              is optimised
            </p>
          </div>
        </div>
